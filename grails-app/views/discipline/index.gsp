		...
		<div id="list-discipline" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<g:sortableColumn property="code" title="${message(code: 'discipline.code.label', default: 'Code')}" />
				...
				<g:each in="${disciplineInstanceList}" status="i" var="disciplineInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${disciplineInstance.id}">${fieldValue(bean: disciplineInstance, field: "code")}</g:link></td>
