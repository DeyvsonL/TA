...
import ta.commom.DisciplineBuilder
...
class DisciplineController {
    ...
    DisciplineBuilder builder = new DisciplineBuilder()
    String pageMessage
    ...
    def update(Discipline disciplineInstance) {
        ...
        request.withFormat {
            form multipartForm {
                flash.message = message(code: 'default.updated.message', args: [message(code: 'Discipline.label', default: 'Evaluation'), disciplineInstance.id])
                redirect disciplineInstance
            }
    ...
    def delete(Discipline disciplineInstance) {
        ...
        request.withFormat {
            form multipartForm {
                flash.message = message(code: 'default.deleted.message', args: [message(code: 'discipline.label', default: 'Evaluation'), disciplineInstance.id])
   ...
   def saveDiscipline(Discipline discipline) {
        discipline.save()
    }
}
